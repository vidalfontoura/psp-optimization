 ...
 * @author Vidal
 */
public abstract class NSGAIIHyperHeuristicTemplate implements Algorithm {
    ...
    protected List<LowLevelHeuristic> lowLevelHeuristics;

    protected String llhComparator;

    protected String choiceFunctionLoggerFileName;

    /** Constructor */
    protected NSGAIIHyperHeuristicTemplate(Builder builder) {
        ...
        llhComparator = builder.llhComparator;
    ...
    public static class Builder {
        ...
        public NSGAIIHyperHeuristicTemplate build(String nsgaIIvariant) {

            NSGAIIHyperHeuristic algorithm;
            if ("NSGAII".equals(nsgaIIvariant)) {
                algorithm = new NSGAIIHyperHeuristic(this);
            } /*
