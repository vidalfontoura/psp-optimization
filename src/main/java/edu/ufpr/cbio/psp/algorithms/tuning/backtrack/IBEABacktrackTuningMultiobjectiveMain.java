...
public class IBEABacktrackTuningMultiobjectiveMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 12) {
            ...
            executions = 30;
            numberOfThreads = 4;
            resultsPath = "results-test-backtrack-ibea";
                                ...
                                for (int h = 0; h < mutationProbabilities.length; h++) {
                                    ...
                                    for (int l = 0; l < backtrackPercentages.length; l++) {
                                        ...
                                        IBEABacktrackExecutingTask ibea2ExecutingTask = new IBEABacktrackExecutingTask(
                                            ...
                                            configuration, configurationFileName, executions, backtrackPercentages[l]);
