...
public class IBEAExecutingTask implements Runnable {
    ...
    public IBEAExecutingTask(PSPProblem problem, Crossover crossover, double crossoverProbability,
    ...
    public void run() {
        ...
        IBEATuningMultiobjectiveMain.executedTasks++;
