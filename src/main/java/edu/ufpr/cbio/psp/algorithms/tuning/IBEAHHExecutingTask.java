...
public class IBEAHHExecutingTask implements Runnable {
    ...
    public IBEAHHExecutingTask(PSPProblem problem, String[] crossovers, double crossoverProbability,
    ...
    public void run() {
        ...
        try (
            ...
            for (int i = 0; i < executions; i++) {
                ...
                IBEAHyperHeuristic algorithm = builder.build();
        ...
        IBEAHHTuningMultiobjectiveMain.executedTasks++;
