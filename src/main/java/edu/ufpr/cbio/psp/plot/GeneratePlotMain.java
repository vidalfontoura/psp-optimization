...
// + "P6HPH2P5H3PH5PH2P4H2P2H2PH5PH10PH2PH7P11H7P2HPH3P6HPH2" + File.separator +
// "SPEA2" + File.separator
...
// /////////////////////////////////////////////////////////////////////////////////////////////////
//
// plot2lines("Energia", "Distancia Euclidiana", 0.0, 50.0, 0.0, 20, plotPoints,
// "Fronteira de Pareto",
// "spea2.png", "png");
//
// }
//
// private static void plot2lines(String labelX, String labelY, double
// rangeStartX, double rangeEndX,
// double rangeStartY, double rangeEndY, List<PlotPoint> plotPoints, String
// titleGraph,
// String pathSave, String fileExtension) throws IOException {
//
// System.out.println("Salvando o arquivo em: " + System.getProperty("user.dir")
// + File.separator + pathSave);
