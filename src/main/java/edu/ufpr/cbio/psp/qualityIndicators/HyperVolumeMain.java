package edu.ufpr.cbio.psp.qualityIndicators;
...
public class HyperVolumeMain {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String EXPERIMENTS_DIR = "psp_experiments/tmp_experiments";
        ...
        HypervolumeCalculator hypervolumeCalculator = new HypervolumeCalculator(2);
        ...
        for (int i = 0; i < nsgaIIExecutions.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                hypervolumeCalculator.addParetoFront(nsgaIIFront);
        ...
        for (int i = 0; i < IBEAExecutions.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                hypervolumeCalculator.addParetoFront(ibeaFront);
            }
        }
        ...
        for (int i = 0; i < speaExecutions.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                hypervolumeCalculator.addParetoFront(spea2Front);
            }
        }
        ...
        for (int i = 0; i < randomExecution.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                hypervolumeCalculator.addParetoFront(randomFront);
            }
        }
        ...
        for (int i = 0; i < nsgaIIExecutions.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                front.setHypervolume2(hypervolumeCalculator.execute(nsgaIIFront));
        ...
        for (int i = 0; i < IBEAExecutions.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                front.setHypervolume2(hypervolumeCalculator.execute(ibeaFront));
        ...
        for (int i = 0; i < speaExecutions.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                front.setHypervolume2(hypervolumeCalculator.execute(spea2front));
        ...
        for (int i = 0; i < randomExecution.length; i++) {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                front.setHypervolume2(hypervolumeCalculator.execute(randomSearchFront));
