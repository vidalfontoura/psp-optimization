package edu.ufpr.cbio.psp.visual;
...
import edu.ufpr.cbio.psp.problem.domain.ResidueType;
...
public class ApplyFixedRelativeSolution {
	...
	private static final String PROTEIN_CHAIN = "PPPPPPHPHHPPPPPHHHPHHHHHPHHPPPPHHPPHHPHHHHHPHHHHHHHHHHPHHPHHHHHHHPPPPPPPPPPPHHHHHHHPPHPHHHPPPPPPHPHH";
	...
	public static void addComponentsToPane(Container pane) {
		...
		JScrollPane jScrollPane = new JScrollPane(myCanvas, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
		...
		applyMovementsButton.addActionListener(listener -> {
			...
			fitnessLabel.setText("Fitness: " + (ResidueUtils.getTopologyContacts(residues, grid).size()
					- ResidueUtils.getCollisionsCount(residues)));
