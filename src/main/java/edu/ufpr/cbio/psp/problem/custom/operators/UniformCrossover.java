...
import edu.ufpr.cbio.psp.problem.custom.operators.IntegerTwoPointsCrossover.Builder;
	...
	public Solution[] doCrossover(double probability,
		...
		if (PseudoRandom.randDouble() < probability) {
			if (parent1.getType().getClass() == IntSolutionType.class) {
				...
				solutionLenght = parent1.getDecisionVariables().length;//tamanho do individuo
				...
				JMetalLogger.logger.severe("UniformCrossover.doCrossover: invalid " +
						"type" +
